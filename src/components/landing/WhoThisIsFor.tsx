...
const notForYou = [
  "You're looking for a \"set it and forget it\" parental control app",
  "You believe the answer is simply banning all technology",
  "You want someone else to solve this for you",
  "Your child is under 8 (this content is designed for 8-16)",
];
