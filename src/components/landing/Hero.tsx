    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-muted/50 to-background py-20 md:py-32">
      ...
      <div className="container">
        <div className="mx-auto max-w-3xl text-center">
          ...
          {/* Headline */}
          <h1 className="mb-6 font-heading text-4xl font-bold tracking-tight text-foreground animate-fade-up md:text-5xl lg:text-6xl" style={{ animationDelay: '0.1s' }}>
            Raise Kids Who Are{' '}
          ...
          {/* Subheadline */}
          <p className="mb-8 text-lg text-muted-foreground animate-fade-up md:text-xl" style={{ animationDelay: '0.2s' }}>
            A proven framework to help your children think critically, create authentically, 
            and thrive in an AI-enhanced world. Start your family's journey today.
          </p>
